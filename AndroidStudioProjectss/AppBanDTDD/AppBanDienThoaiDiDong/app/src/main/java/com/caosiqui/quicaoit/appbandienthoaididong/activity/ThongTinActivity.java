...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(cuahangdienthoai).title("Cửa hàng Laptop").snippet("48 Cao Thắng, Đà Nẵng").icon(BitmapDescriptorFactory.defaultMarker()));
